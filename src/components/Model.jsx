              ...
              <div className="model_wrapper">
                  ...
                  <h3 className='title'>{proudctData.title}</h3>
                      ...
                      <div className="AddtoCart">
                          <input type="number" min="1" max="100" className="AddtoCart_input" value={qty} onChange={ (e) => setQty(e.target.value) } />
                          <button onClick={() => addToCart({...proudctData , quantity:qty})} className='btn_pro' type="submit"> <span><AiOutlineShoppingCart /></span>  Add to Cart
                          </button>
                         </div>
                      </div>
              </div>
