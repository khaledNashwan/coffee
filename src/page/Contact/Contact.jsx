        ...
        <div className="contianer contact-container">
           ...
           <div className="aside-image">
              ...
              <ul className="contact-socials">
                        ...
                        <li> <a href="https://www.linkedin.com/" target="_blank"><BsWhatsapp /> </a> </li>
            ...
            <form  className="contact-form">
                 <div className="form-name">
                    <input className='input' type="text" name="First Name" placeholder="First Name" required />
                    <input className='input' type="text" name="Last Name" placeholder="Last Name" required />
                 </div>
                <input className='input' type="email" name="Email Address" placeholder=" your Email Address" required />
                 <textarea name="Massage"  placeholder="Massage"  rows="7" required></textarea>
                <button className="btn_header" type="submit">send Massage </button>
          </form>
        </div>
      </section>
